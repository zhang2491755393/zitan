$("#enroll").click(function () {
    ...
    $(document).on("click",".zhucheuser",function(){
        $("#login").hide();
        $("#enrollbox").show();
    })
    //点x消失
    ...
    // $("#lijilogin1").click(function () {
        $(document).on("click","#lijilogin1",function(){
...
$("#landing").click(function () {
    $("#login").fadeIn("slow");
    $(document).on("click","#lijilogin",function(){
            ...
            success: function (obj) {
                if (obj[0]["code"] == 1) {
                    ...
                    if ($("#jizhuinp").prop("checked")) {
                        ...
                        setCookie("userid",obj[0]["id"],7)
                    } else {
                        setCookie("username", username,);
                        setCookie("userid",obj[0]["id"],);
                    }
